...
public enum ErrorCode {
    ...
    /* * 7. 이미지 (Image)
     */
    INVALID_IMAGE_TYPE(HttpStatus.BAD_REQUEST, "INVALID_INPUT", "유효하지 않은 이미지 타입입니다. (PROFILE, REVIEW, INQUIRY, POST, PRODUCT, MARKET, CATEGORY, SIGNUP_DOCUMENT, CREATOR_DOCUMENT)"),
