...
public interface ProductInquiryControllerDocs {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = ProductInquiryResponse.class),
                            examples = {
                                    @ExampleObject(
                                            name = "답변 대기 예시",
                                            value = "{\n" +
            ...
            @ApiResponse(
                    responseCode = "403",
                    description = "해당 상품 문의에 대한 권한 없음 - Status: 403 Forbidden",
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = {
            ...
            @ApiResponse(
                    responseCode = "404",
                    description = "상품 문의 또는 사용자를 찾을 수 없음 - Status: 404 Not Found",
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = {
    ...
    ProductInquiryResponse getInquiryDetail(
            @Parameter(hidden = true) UserPrincipal userPrincipal,
            @Parameter(description = "조회할 상품 문의 ID", required = true, example = "1", in = io.swagger.v3.oas.annotations.enums.ParameterIn.PATH)
